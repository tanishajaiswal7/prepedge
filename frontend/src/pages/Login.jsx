 ...
 const API_URL = import.meta.env.VITE_BACKEND_URL;
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-gradient-to-br from-indigo-500 via-purple-500 to-blue-500 px-4 py-8">
      <h1 className="text-white text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 lg:mb-10 drop-shadow-lg tracking-wide text-center">
        Welcome Back to <span className="text-yellow-300">ProScout</span>
      </h1>

      <div className="flex flex-col bg-white/10 backdrop-blur-lg shadow-2xl shadow-black/30 p-6 sm:p-8 lg:p-12 rounded-2xl w-full max-w-md items-center gap-4 lg:gap-6 border border-white/20">
        <h2 className="font-bold text-2xl lg:text-3xl text-white tracking-wide drop-shadow-md text-center">
          Log In
        </h2>
        ...
        <button
          onClick={handleLogin}
          className="w-full py-3 mt-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold text-base lg:text-lg shadow-lg hover:scale-[1.02] active:scale-[0.98] transition"
        >
          Login
        </button>
